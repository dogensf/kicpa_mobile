...
public class FileMngController {
	...
	@RequestMapping("/cmm/fms/selectKicpaFileInfs.do")
	public String selectKicpaFileInfs(@ModelAttribute("searchVO") FileVO fileVO, @RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
		String atchFileId = (String) commandMap.get("param_atchFileId");

...
import adminwork.let.cop.com.service.EgovUserInfManageService;
import adminwork.let.cop.com.service.UserInfVO;
...
public class EgovUserInfManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserInfManageService {
     ...
     * 동호회 운영자 목록을 조회한다.
     * 
     * @see adminwork.let.cop.com.service.EgovUserInfManageService#selectClubOprtrList(adminwork.let.cop.com.service.UserInfVO)
     */
     ...
     * 동호회 사용자 목록을 조회한다.
     * 
     * @see adminwork.let.cop.com.service.EgovUserInfManageService#selectClubUserList(adminwork.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 관리자 목록을 조회한다.
     * 
     * @see adminwork.let.cop.com.service.EgovUserInfManageService#selectCmmntyMngrList(adminwork.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 사용자 목록을 조회한다.
     * 
     * @see adminwork.let.cop.com.service.EgovUserInfManageService#selectCmmntyUserList(adminwork.let.cop.com.service.UserInfVO)
     */
     ...
     * 사용자 정보에 대한 목록을 조회한다.
     * 
     * @see adminwork.let.cop.com.service.EgovUserInfManageService#selectUserList(adminwork.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see adminwork.let.cop.com.service.EgovUserInfManageService#selectAllClubUser(adminwork.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see adminwork.let.cop.com.service.EgovUserInfManageService#selectAllCmmntyUser(adminwork.let.cop.com.service.UserInfVO)
     */

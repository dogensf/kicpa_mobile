...
public class LoginDAO extends EgovAbstractDAO {
    ...
    public LoginVO kicpaLogin(LoginVO vo) throws Exception {
    	return (LoginVO)select("loginDAO.kicpaLogin", vo);
    }
    ...
    public void setUserAuthorCode(LoginVO vo) throws Exception {
    	insert("loginDAO.setUserAuthorCode", vo);
    }
	 ...
	 * @exception Exception
	 */
    public void setUserInfo(LoginVO vo) throws Exception {
    	insert("loginDAO.setUserInfo", vo);
    }

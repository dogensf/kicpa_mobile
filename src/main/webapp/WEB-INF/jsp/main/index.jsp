...
<html lang="ko">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								<li class="menu-item" aria-haspopup="true">
									<a href="javascript:addNewTab();" class="menu-link">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<!-- Tab Headers Start -->
								<ul class="tabs" id="addajaxtab">
								<li><a href="#tabview10">Tab 1</a></li>
								<li><a href="#tabview11">Tab 2</a></li>
								<li><a href="#tabview12">Tab 3</a></li>
								</ul>
								<!-- Tab Headers End --> 
								<!-- Tab Body Start -->
								<div class="tabcontents" id="addajaxtabbody">
								<div id="tabview10"> Lorem ipsum contents...... </div>
								<div id="tabview11"> Some more static content... </div>
								<div id="tabview12"> A bit more... </div>
								</div>
								</div>
		...
		<script src="js/kik.tabs.js"></script>
		<script>
			$.noConflict();
			var $ = jQuery;

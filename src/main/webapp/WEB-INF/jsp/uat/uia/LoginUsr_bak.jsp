...
function fnInit() {
    ...
    document.loginForm.id.value = "0961620141016";
}
//-->
</script>
</head>
                                ...
                                <div class="user_login_ultop">
                                    <ul>
                                        <li>
                                            ...
                                            <input type="text" class="input_style" title="아이디를 입력하세요." id="id" name="id" value="0961620141016"  maxlength="15" />
                                        </li>
                                        <li>
                                            <label for="password">비밀번호</label>
                                            <input type="password" class="input_style" maxlength="25" title="비밀번호를 입력하세요." id="password" name="password"  value="1"

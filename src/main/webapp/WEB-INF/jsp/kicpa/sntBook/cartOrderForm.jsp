...
<form name="mobileweb" id="mobileweb" method="post" accept-charset="euc-kr">
    <%--<input type="hidden" name="P_NEXT_URL" value="http://localhost:8079/kicpa/sntBook/orderReponse.do">--%>
    <input type="hidden" name="P_NEXT_URL" value="https://mkip.kicpa.or.kr/kicpa/sntBook/orderReponse.do">
				...
				<div class="form">
					<div class="inp-box">
		                <div class="inp-check">
			                ...
			                <div class="terms_box" contenteditable="false" style="height:100px;overflow-y:auto;">

		            ...
		            <dd>
		              <span class="compact-select" style="width: 70px;">
		                <select name="status" id="status">
		                  ...
		                  <option value="담당자 확인"  <c:if test="${searchVO.status == '담당자 확인'}">selected="selected"</c:if>>담당자 확인</option>
		            ...
		            <dd>
		              <span class="compact-select" style="width: 120px;">
		                <select name="searchCnd" id="searchCnd">
		                  ...
		                  <option value="2" <c:if test="${searchVO.searchCnd == '2'}">selected="selected"</c:if>>담당부서</option>
		                </select>
		              </span>
		            </dd>

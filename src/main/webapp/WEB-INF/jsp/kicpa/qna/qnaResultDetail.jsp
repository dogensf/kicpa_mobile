      ...
      <div class="basic-detail-view-table">
        <table>
          ...
          <tbody>
            ...
            <tr>
              <th>민원처리상태</th>
              <td colspan="3"><c:out value="${result.status }"/></td>
            </tr>
            <tr>
	              ...
	              <td colspan="3">
	                <div class="answer-types">
	                  <span class="check nan">
	                    <input type="checkbox" id="a-1" <c:if test="${result.answer_ty eq '온라인 대응'}">checked</c:if> disabled>
	                    <label for="a-1">온라인 대응</label>
	                  </span>
	                  <span class="check nan">
	                    <input type="checkbox" id="a-2" <c:if test="${result.answer_ty eq '유선대응'}">checked</c:if> disabled>
	                    <label for="a-2">유선대응</label>
	                  </span>
	                  <span class="check nan">
	                    <input type="checkbox" id="a-3" <c:if test="${result.answer_ty eq '원격지원'}">checked</c:if> disabled>

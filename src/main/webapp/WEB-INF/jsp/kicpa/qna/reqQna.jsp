	        ...
	        <table>
	          ...
	          <tbody>
	            ...
	            <tr>
	              <th>작성자 이메일</th>
	              <td>
	              	<input type="text" name="reg_email" id="reg_email" value="" placeholder="xxxxx@gmail.com">

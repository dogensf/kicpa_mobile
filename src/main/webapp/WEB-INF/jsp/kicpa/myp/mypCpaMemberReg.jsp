...
<body id="mypCpaMemberReg_body">
  <div class="wrap">
      ...
      <section class="content">
        ...
        <div class="mypage-wrap">
          <form id="mypCpaMemberReg_agreeForm">
            ...
            <div class="inp-box">
              <div class="inp-check">
                <input class="mypCpaMemberReg_check" type="checkbox" name="agreeInfoYn1" id="mypCpaMemberReg_agreement1"
                       value="Y"/>
                <label for="mypCpaMemberReg_agreement1">개인정보 수집 및 이용동의 (필수)</label>
              </div>

              <div class="terms_box">
                한국공인회계사회는 공인회계사의 지도·감독에 관한 사무를 수행하기 위하여 공인회계사 및 수습공인회계사에 대한 개인정보를 아래와 같이 수집하고 있으며, 제공받은 개인정보는 공인회계사 및
                수습공인회계사의 사이버교육 제공 등 다양한 서비스제공과 기타 통신연락 수단으로 이용됩니다.<br>
            ...
            <div class="inp-box">
              <div class="inp-check">
                <input class="mypCpaMemberReg_check" type="checkbox" name="agreeInfoYn2" id="mypCpaMemberReg_agreement2"
                       value="Y"/>
                <label for="mypCpaMemberReg_agreement2">개인정보 처리 위탁 동의 (필수)</label>
              </div>

              <div class="terms_box">
                한국공인회계사회는 수습공인회계사의 수습연수와 공인회계사의 연수를 위해 사이버교육 시스템을 구축하여 운영하고 있습니다. 이와 관련하여 한국공인회계사회는 사이버연수 전문업체에 사이버교육을
                위탁 운영하고 있으며, 수습공인회계사와 공인회계사의 사이버 교육 서비스 제공을 위하여 아래의 개인정보를 한국공인회계사회가 사이버교육을 위탁 운영하는 업체에 제공하는 것에 대해 동의를
                요청합니다.
              </div>
            </div>
    ...
    <div class="container myPageMemInfoTabMove" id="mypCpaMemberReg_aidMberInfo">
        ...
        <div class="mypage-wrap">
          <form id="mypCpaMemberReg_cpaCareerInfoForm">
            ...
            <div class="inp-box">
              ...
              <input type="date" id="mypCpaMember_registDe" name="registDe" data-placeholder="공인회계사 등록예정일 날짜를 입력하세요."
            ...
            <div style="display: none;" class="inp-box mypCpaMemberReg_auditReg">
              ...
              <div class="phone" style="display: flex;">
                <input type="text" style="width: 100%;" id="mypCpaMember_auditNm" name="auditNm" placeholder="감사인 등록"
                       title="감사인명" disabled/>
                <input type="text" style="width: 100%;" id="mypCpaMember_auditAdres" name="auditAdres"
                       placeholder="감사인 주소등록" title="감사인주소" disabled/>
            ...
            <div style="display: none;" class="inp-box mypCpaMemberReg_closedClReg">
              ...
              <input type="text" id="mypCpaMember_closedClNm" name="closedClNm" placeholder="회원(휴업)분류를 선택하세요."
                     readonly/>
      ...
      <!-- 이전페이지로 이동 -->
      <div class="btn-page-bottom">
        <button class="btn-text-back" onclick="mypMemberReg.mypMemberReg_tabMove('mypCpaMemberReg_agreeInfo')"
                type="button">이전페이지로 이동
        </button>
      </div>
    ...
    <div class="container myPageMemInfoTabMove" id="mypCpaMemberReg_nmstOthbcInfo">
      ...
      <!-- 개인정보화면 이동(수정모드) -->
      <div class="btn-page-bottom">
        <button class="btn-text-blue mypCpaMember_backBtn" onclick="mypMemberReg.mypMemberReg_backMove();"
                type="button">취소
        </button>
      </div>
      ...
      <!-- 이전페이지로 이동 -->
      <div class="btn-page-bottom">
        <button class="btn-text-back mypCpaMember_preBtn"
                onclick="mypMemberReg.mypMemberReg_tabMove('mypCpaMemberReg_aidMberInfo')" type="button">이전페이지로 이동
        </button>
      </div>
    ...
    <div class="container myPageMemInfoTabMove" id="mypCpaMemberReg_atchFileInfo">
        ...
        <div class="mypage-wrap">
          <form id="mypCpaMemberReg_atchFileInfoForm">
            ...
            <div class="inp-box">
              ...
              <input class="mypCpaMemberReg_fileChange" type="file" id="mypCpaMember_passCrtiFileId"
                     name="passCrtiFileId" readonly/>
              ...
              <button type="button" class="regFlagFPassCrtiFileIdDelHide"
                      onclick="mypMemberReg.mypCpaMember_atchFileInfoRemove('regFlagFPassCrtiFileIdDelHide')"
                      style="display:none; position: absolute; right: 0; border: 1px solid #0070C0; border-radius: 1.6rem; height: 2.4rem; padding: 0 2.2rem; font-size: 1.4rem; font-weight: 400; line-height: 2rem; color: #0070C0;">
                삭제
              </button>
            </div>
            ...
            <div class="inp-box">
              ...
              <input class="mypCpaMemberReg_fileChange" type="file" id="mypCpaMember_rsumFileId" name="rsumFileId"
                     readonly/>
              ...
              <button type="button" class="regFlagFRsumFileIdDelHide"
                      onclick="mypMemberReg.mypCpaMember_atchFileInfoRemove('regFlagFRsumFileIdDelHide')"
                      style="display:none; position: absolute; right: 0; border: 1px solid #0070C0; border-radius: 1.6rem; height: 2.4rem; padding: 0 2.2rem; font-size: 1.4rem; font-weight: 400; line-height: 2rem; color: #0070C0;">
                삭제
              </button>
            </div>
            ...
            <div class="inp-box">
              ...
              <input class="mypCpaMemberReg_fileChange" type="file" id="mypCpaMember_atchFileId" name="atchFileId"
                     readonly/>
              ...
              <button type="button" class="regFlagFEmplCrtiDelHide"
                      onclick="mypMemberReg.mypCpaMember_atchFileInfoRemove('regFlagFAtchFileIdDelHide')"
                      style="display:none; position: absolute; right: 0; border: 1px solid #0070C0; border-radius: 1.6rem; height: 2.4rem; padding: 0 2.2rem; font-size: 1.4rem; font-weight: 400; line-height: 2rem; color: #0070C0;">
                삭제
              </button>
            </div>
      ...
      <!-- 이전페이지로 이동 -->
      <div class="btn-page-bottom">
        <button class="btn-text-back" onclick="mypMemberReg.mypMemberReg_tabMove('mypCpaMemberReg_nmstOthbcInfo')"
                type="button">이전페이지로 이동
        </button>
      </div>
    ...
    <div class="container myPageMemInfoTabMove" id="mypCpaMemberReg_reviewInfo">
      <section class="head-pop">
        ...
        <button class="btn-close" type="button"
                onclick="location.href='${pageContext.request.contextPath}/kicpa/myp/myPage.do?Pin=${mypCpaMemberRegPin}'">
          <span>닫기</span>
        </button>
      </section>
      ...
      <section class="content">
        ...
        <div class="mypage-wrap">
          <div style="display:flex;">
            <p class="submit-txt" id="mypCpaMember_cpaRegForm"
               style="width: 50%; border-bottom: 0; margin-bottom: 35px;">
              공인회계사<br/>
              등록신청서
            </p>
            <p class="submit-txt" id="mypCpaMember_cpaMemRegForm"
               style="width: 50%; border-bottom: 0; margin-bottom: 35px;">
              입회신청서
            </p>
          </div>
      ...
      <div class="btn-page-bottom">
        <button class="btn-text-back mypCpaMember_preBtn"
                onclick="mypMemberReg.mypMemberReg_tabMove('mypCpaMemberReg_atchFileInfo')" type="button">이전페이지로 이동
        </button>
      </div>
      ...
      <div class="sticky-bottom">
        ...
        <button class="btn-sticky mypCpaMember_mypBtn" type="button"
                onClick="location.href='${pageContext.request.contextPath}/kicpa/myp/myPage.do?Pin=${mypCpaMemberRegPin}'">
          확인
        </button>
      </div>
    ...
    <div class="container myPageMemInfoTabMove" id="mypCpaMemberReg_aidDuesInfo">
      ...
      <!-- 페이지하단 버튼 -->
      <div class="sticky-bottom">
        <button class="btn-sticky mypCpaMember_nextBtn" type="button" id="mypCpaMemberReg_aidDuesInfoSaveBtn">확인
        </button>
        <button class="btn-sticky mypCpaMember_mypBtn" type="button"
                onClick="location.href='${pageContext.request.contextPath}/kicpa/myp/myPage.do?Pin=${mypCpaMemberRegPin}'">
          확인

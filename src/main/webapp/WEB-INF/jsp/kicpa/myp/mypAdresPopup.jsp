...
<% 
	...
	String confmKey = "devU01TX0FVVEgyMDIxMTEyNjE4NTcxMzExMTk1OTg="; // 검색API 승인키
...
<script src="<c:url value='/'/>js/kicpa/myp/addrlink.js?ver=1"></script>
<link href="<c:url value='/'/>css/kicpa/myp/addrlink.css?ver=1" rel="stylesheet"/>
...
<script language="javascript">
	...
	function setParent(){
		...
		opener.mypAdresCallBack(rtRoadFullAddr, rtAddrPart1, rtAddrDetail, rtAddrPart2, rtEngAddr, rtJibunAddr, rtZipNo, rtAdmCd, rtRnMgtSn, rtBdMgtSn, rtDetBdNmList, rtBdNm, rtBdKdcd, rtSiNm, rtSggNm, rtEmdNm, rtLiNm, rtRn, rtUdrtYn, rtBuldMnnm, rtBuldSlno, rtMtYn, rtLnbrMnnm, rtLnbrSlno, rtEmdNo, "${flag}");
...
<body onload="cpaAdresPopupOpen();" class ="visualSection">
				...
				<div class="detail"  style="display:none;" id="resultData">
					...
					<table class="data-row">
						...
						<tbody>
							...
							<tr>
								<th scope="row"><label for="rtAddrDetail">상세주소입력</label></th>
								<td>

...
<!-- script :: End -->
    ...
    <script>
        $(document).ready(function() {
            window.opener.myPageInfo.myPage_memberConfirmSuccMove('${sDupInfo}', '${movePage}', '${moveFlag}', '${pin}');
            self.close();
        });

        /*function fn_mypCpaConfirmSucc_closed(DI,,HP){
            window.opener.myPage_memberConfirmSuccMove('${sDupInfo}', '${movePage}', '${pin}');
            self.close();
        }*/
    </script>
</head>

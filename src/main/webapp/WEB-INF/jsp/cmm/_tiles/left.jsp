...
<script>
function clearMenu(){
	$("#mainTopMenu").children("li").each(function( index, element ) {			 	
		 //console.log("menu_1 : "+$(this).find('.menu-text:first').text());
	     $(this).children().children("ul").children("li").each(function( index, element ) {			    	 
	    	 //console.log("menu_2 :	 "+$(this).find('.menu-text:first').text());					 				 
			 $(this).children().children("ul").children("li").each(function( index, element ) {
	    		 //console.log("menu_3 :	 	"+$(this).find('.menu-text:first').text());				    		 	  
	    		 if(!$(this).is(':visible')){
	    			 $(this).show();
	    		 }
...
function findMenu(nm){
	...
	$("#mainTopMenu").children("li").each(function( index, element ) {		 		 
	     ...
	     $(this).children().children("ul").children("li").each(function( index, element ) {
	    	 var showChk_2 = 'N';		    	 
	    	 //console.log("menu_2 :	 "+$(this).find('.menu-text:first').text());
			 if($(this).find('.menu-text:first').text() == nm){				 
				/*  if($(this).hasClass("menu-item-submenu") == true) {
	    			 $(this).addClass("menu-item-open");
	    			 if(!$(this).children('.menu-submenu').is(':visible')){
	    				 $(this).children('.menu-submenu').show();
	    			 }
	    		 ...
	    		 $(this).children().children("ul").children("li").each(function( index, element ) {
		    		 ...
		    		 if($(this).find('.menu-text:first').text() == nm){		    			 
		    			 showChk_1 = 'Y';
		    			 showChk_2 = 'Y';
		    			 //$('#kt_aside_menu').scrollTop(( $('#kt_aside_menu').scrollTop() - $(this).scrollTop())/4 + $('#kt_aside_menu').scrollTop());
		    		 }
		    	 });	    		
	    	 }	    	 
	    	 if(showChk_2 == 'Y' && $(this).hasClass("menu-item-parent") != true){
	    		 if($(this).hasClass("menu-item-submenu") == true) {
	    			 $(this).addClass("menu-item-open");
	    			 if(!$(this).children('.menu-submenu').is(':visible')){
	    				 $(this).children('.menu-submenu').show();
	     ...
	     if(showChk_1 == 'Y'){	    	 
   			...
   			//$('#kt_aside_menu').scrollTop(( $('#kt_aside_menu').height() - $(this).scrollTop())/2 + $('#kt_aside_menu').scrollTop());
   			//$('#kt_aside_menu').scrollIntoView({behavior : 'smooth'});
   			$('#kt_aside_menu').scrollTop($(this).offset().top);
   			 showChk_1 = 'N';
...
function changeMenu(nm){
	var menu = $("#mainTopMenu");
	if(nm == '' || nm == null){
		 clearMenu();
	}else{
		 clearMenu();
		...
		$("#mainTopMenu").children("li").each(function( index, element ) {
			 var hideChk_1 = 'Y';
			 if(!$(this).find('.menu-text:first').text().indexOf(nm) == -1){
				 hideChk_1 = 'N';
			 }
				 //console.log("menu_1 : "+$(this).find('.menu-text:first').text());
			     $(this).children().children("ul").children("li").each(function( index, element ) {
			    	 ...
			    	 //console.log("menu_2 :	 "+$(this).find('.menu-text:first').text());
					 if($(this).find('.menu-text:first').text().indexOf(nm) == -1 && hideChk_1 =='Y'){				 
						 $(this).children().children("ul").children("li").each(function( index, element ) {
				    		 //console.log("menu_3 :	 	"+$(this).find('.menu-text:first').text());
				    		 if($(this).find('.menu-text:first').text().indexOf(nm) == -1 && hideChk_1 =='Y' && hideChk_2 =='Y'){
				    			 $(this).hide();	    			 
				    		 }else{
				    			 hideChk_1 = 'N';
				    			 hideChk_2 = 'N';				    			 
			    	 ...
			    	 if(hideChk_2 == 'Y' && $(this).hasClass("menu-item-parent") == true){
			    		 $(this).hide();
			    	 }else{
			    		 if($(this).hasClass("menu-item-submenu") == true) {
			    			 $(this).addClass("menu-item-open");
...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
	...
	<div class="brand flex-column-auto" id="kt_brand">
		<div class="search-wrap">
			<form name="searchForm" class="searchForm" method="get" onsubmit="return false">
				<input type="text" id="GlobalKeywords" name="searchInput" class="searchInput" onchange="javascript:changeMenu(this.value);" placeholder="검색">
			</form>			
		</div>
	</div>
	<!--end::Search-->
	...
	<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
		...
		<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
			...
			<!--begin::Menu Nav-->
			<ul class="menu-nav" id="mainTopMenu">
				<c:forEach var="head" items="${list_headmenu}" varStatus="status">
					<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
						<a href="javascript:;" class="menu-link menu-toggle">
							...
							<span class="menu-text">${head.menuNm }</span>
						...
						<i class="menu-arrow"></i>
							<ul class="menu-subnav">
								...
								<c:forEach var="sub1" items="${list_menulist}" varStatus="status">
									<c:if test="${head.menuNo eq sub1.upperMenuId }">
										<c:choose> 
											<c:when test="${sub1.progrmFileNm eq 'dir' }">
												<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
													<a href="javascript:;" class="menu-link menu-toggle">
														<i class="menu-bullet menu-bullet-line">
															<span></span>
														</i>
														<span class="menu-text">${sub1.menuNm }</span>
													...
													<i class="menu-arrow"></i>
														<ul class="menu-subnav">
															<c:forEach var="sub2" items="${list_menulist}" varStatus="status">
																<c:if test="${sub1.menuNo eq sub2.upperMenuId }">
																	<li class="menu-item" aria-haspopup="true">
																		<a href="javascript:addNewTab('${sub2.progrmFileNm }','${sub2.chkURL }','${sub2.menuNm }');" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
																			<span class="menu-text">${sub2.menuNm }</span>
																		</a>
																	</li>
																</c:if>
															</c:forEach>
											...
											<c:otherwise>
												<li class="menu-item" aria-haspopup="true">
													<a href="javascript:addNewTab('${sub1.progrmFileNm }','${sub1.chkURL }','${sub1.menuNm }');" class="menu-link">
														<i class="menu-bullet menu-bullet-dot">
															<span></span>
														</i>
														<span class="menu-text">${sub1.menuNm }</span>
			...
			<%-- <ul class="menu-nav">
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">일반업무</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
						<ul class="menu-subnav">
							...
							<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
								<a href="javascript:;" class="menu-link menu-toggle">
									...
									<span class="menu-text">일반업무1</span>
									<span class="menu-label">
										<span class="label label-rounded label-primary">6</span>
									</span>
									<i class="menu-arrow"></i>
								...
								<div class="menu-submenu">
									...
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="javascript:addNewTab('budgetFrmtn','/kicpa/budgetFrmtn.do','예산편성');" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
												<span class="menu-text">예산편성</span>
											</a>
										</li>
										<li class="menu-item" aria-haspopup="true">
											<a href="javascript:addNewTab('docSendList','/kicpa/docSendList.do','발송문서');" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
												<span class="menu-text">발송문서</span>
											</a>
										</li>
										<li class="menu-item" aria-haspopup="true">
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">공인회계사 통합조회</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">합격자 정보관리</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">수습공인회계사 정보관리</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">공인회계사 정보관리</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">세무사/세무대리</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">감사인 등록</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">회원직무</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">회원연수</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">직원연수</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">민원시스템</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">감리업무</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">외감기업정보</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
				...
				<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						...
						<span class="menu-text">손해배상공동기금</span>
						<i class="menu-arrow"></i>
					</a>
					<div class="menu-submenu">
						<i class="menu-arrow"></i>
